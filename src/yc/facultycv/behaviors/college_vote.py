...
from yc.facultycv.interfaces import ICollegeVoteMarker
...
KEY = 'yc.facultycv.behaviors.college_vote.CollegeVote'


@implementer(ICollegeVote)
@adapter(ICollegeVoteMarker)
class CollegeVote(object):
