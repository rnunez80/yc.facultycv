...
class IPbactionportfolioa(model.Schema):
    """ Marker interface and Dexterity Python Schema for Pbactionportfolioa
    """
    ...
    directives.write_permission(FramingStatement='yc.facultycv.AddPbaction')
    directives.read_permission(FramingStatement='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        ReflectiveStatement='yc.facultycv.AddPbaction')
    directives.read_permission(ReflectiveStatement='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        SamplesAndCommentary1='yc.facultycv.AddPbaction')
    directives.read_permission(SamplesAndCommentary1='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        SamplesAndCommentary2='yc.facultycv.AddPbaction')
    directives.read_permission(SamplesAndCommentary2='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        SamplesAndCommentary3='yc.facultycv.AddPbaction')
    directives.read_permission(SamplesAndCommentary3='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        PublicationsAndOtherScholarlyWorks1='yc.facultycv.AddPbaction')
    directives.read_permission(PublicationsAndOtherScholarlyWorks1='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        PublicationsAndOtherScholarlyWorks2='yc.facultycv.AddPbaction')
    directives.read_permission(PublicationsAndOtherScholarlyWorks2='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        PublicationsAndOtherScholarlyWorks3='yc.facultycv.AddPbaction')
    directives.read_permission(PublicationsAndOtherScholarlyWorks3='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        PublicationsAndOtherScholarlyWorks4='yc.facultycv.AddPbaction')
    directives.read_permission(PublicationsAndOtherScholarlyWorks4='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        PublicationsAndOtherScholarlyWorks5='yc.facultycv.AddPbaction')
    directives.read_permission(PublicationsAndOtherScholarlyWorks5='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(
        researchStatement='yc.facultycv.AddPbaction')
    directives.read_permission(researchStatement='yc.facultycv.ViewPBDeptCommittees')
    ...
    directives.write_permission(appendix='yc.facultycv.AddPbaction')
    directives.read_permission(appendix='yc.facultycv.ViewPBDeptCommittees')
...
@implementer(IPbactionportfolioa)
class Pbactionportfolioa(Item):
    """
    """
