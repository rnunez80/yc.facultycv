...
class IPbactionportfolioc(model.Schema):
    """ Marker interface and Dexterity Python Schema for Pbactionportfolioc
    """
    ...
    # directives.omitted('deptVotesYes')
    # deptVotesYes = schema.TextLine(
    #     title=_('Deptvotesyes'),
    #     required=False,
    # )
    #
    # directives.omitted('deptVotesAbstain')
    # deptVotesAbstain = schema.TextLine(
    #     title=_('Deptvotesabstain'),
    #     required=False,
    # )
    #
    # directives.omitted('deptVotesNo')
    # deptVotesNo = schema.TextLine(
    #     title=_('Deptvotesno'),
    #     required=False,
    # )
    # new field
...
@implementer(IPbactionportfolioc)
class Pbactionportfolioc(Item):
    """
    """
